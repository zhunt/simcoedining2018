...
/**
 * HomepageCityNeighbourhoods cell
 */
class HomepageCityNeighbourhoodsCell extends Cell
{
    ...
    {
        $this->loadModel('CityNeighbourhoods');
        // $this->loadModel('VenueServices');

        $cuisinesList = $this->CityNeighbourhoods->getNeighbourhoodsWithVenues($cityId = $id )->toArray();
