 ...
 * @var \App\Model\Entity\VenueProduct $venueProduct
 */
?>
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        <li class="heading"><?= __('Actions') ?></li>
        <li><?= $this->Html->link(__('Edit Venue Product'), ['action' => 'edit', $venueProduct->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Venue Product'), ['action' => 'delete', $venueProduct->id], ['confirm' => __('Are you sure you want to delete # {0}?', $venueProduct->id)]) ?> </li>
        <li><?= $this->Html->link(__('List Venue Products'), ['action' => 'index']) ?> </li>
...
<div class="venueProducts view large-9 medium-8 columns content">
    <h3><?= h($venueProduct->name) ?></h3>
    ...
    <div class="related">
        ...
        <?php if (!empty($venueProduct->venues)): ?>
        <table cellpadding="0" cellspacing="0">
            ...
            <?php foreach ($venueProduct->venues as $venues): ?>
            <tr>
                <td><?= h($venues->id) ?></td>
                <td><?= h($venues->name) ?></td>
                <td><?= h($venues->slug) ?></td>
