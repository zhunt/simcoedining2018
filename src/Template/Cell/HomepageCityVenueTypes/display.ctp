                    ...
                    <div class="col-12 col-md-6 col-lg-4 col-xl-4 ">
                        <ul class="list-unstyled">
                            <?php foreach ($venueTypeList[0] as $venueType): ?>
                                <li>
                                    <a title="<?= $venueType['name'] ?> in <?= $city ?>" href="/search/?store-type=<?= $venueType['slug'] ?>&city=<?= $citySlug ?>"><?= $venueType['name'] ?> <small class="text-muted d-none d-md-block">(<?= $venueType['total_venues'] ?> places)</small></a>
                                </li>
                            <?php endforeach; ?>
                        </ul>
                    </div>
